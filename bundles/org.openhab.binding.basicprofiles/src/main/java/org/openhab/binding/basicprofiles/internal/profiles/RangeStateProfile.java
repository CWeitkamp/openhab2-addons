...
import static org.openhab.binding.basicprofiles.internal.factory.BasicProfileFactory.RANGE;
...
/***
 * This is the default implementation for a {@link RangeStateProfile}.
 *
 * @author Christoph Weitkamp - Initial contribution
 */
@NonNullByDefault
public class RangeStateProfile implements StateProfile {

    public static final String LOWER_PARAM = "lower";
    public static final String UPPER_PARAM = "upper";
    public static final String INVERTED_PARAM = "inverted";

    private final Logger logger = LoggerFactory.getLogger(RangeStateProfile.class);
    ...
    public RangeStateProfile(ProfileCallback callback, ProfileContext context) {
